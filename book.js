...
function renderRows() {
    for (let book of dataSource) {
        ...
        td1.onclick = () => {
            document.location.href = `./aboutBook.html?title=${book.title}&genre=${book.genre}&authors=${book.authors}&review=${book.review}&img=${book.img}&dateOfPublication=${book.dateOfPublication}`
        }
